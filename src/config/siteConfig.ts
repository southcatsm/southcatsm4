...
const SITE_LANG = "zh_CN"; // en/ja/zh_CN
...
export const siteConfig: SiteConfig = {
	...
	themeColor: {
		hue: 240, // 0~360. red-0, cyan-200, bluegreen-250, pink-345
		fixed: true, // whether hidden for visitors
	},
	...
	navbarTitle: {
		...
		// text
		text: "Southcatsm",
		// navbar-icon public/assets/home/home.webp
		icon: "assets/home/home.jpg",
		// web logo
		logo: "assets/home/home.jpg",
	},
	...
	bangumi: {
		userId: "southcatsm", // bangumi id
		fetchOnDev: false, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
	},

	bilibili: {
		vmid: "635978552", // bilibili id
	...
	banner: {
		...
		homeText: {
			...
			subtitle: [
				...
				"我是大白兔奶糖 融化了就黏你身上",
				"乐观积极必定风生水起，心里住着小太阳，日子才会清透明亮",
			],
			typewriter: {
				enable: true, // sec-title

				speed: 225, 
				deleteSpeed: 100, 
				pauseTime: 4000, // maintain how ms
			},
		},

		credit: {
			enable: false, // whether show pic's source
