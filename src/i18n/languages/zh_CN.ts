...
export const zh_CN: Translation = {
  ...
  [Key.comments]: "评论",
  [Key.friends]: "友链",
  [Key.friendsSubtitle]: "来看看为本站作出贡献的人吧",
  [Key.friendsSearchPlaceholder]: "搜索名称或描述...",
  [Key.friendsFilterAll]: "全部",
  [Key.friendsNoResults]: "未找到匹配的结果",
  [Key.friendsVisit]: "访问",
  ...
  [Key.projectsAll]: "全部",
  [Key.projectsTools]: "小工具",
  [Key.projectsNovels]: "轻小说",
  [Key.projectTag]: "标签",
  [Key.projectGuider]: "帮助文档",
  [Key.projectSourceCode]: "源代码",
  [Key.projectDescription]: "项目描述",
  [Key.projectStatus]: "项目状态",
  [Key.projectStatusCompleted]: "已完成",
  [Key.projectStatusRecommend]: "推荐",
  [Key.projectStatusHot]: "火爆",
  [Key.projectStatusPlanned]: "正在企划",
  [Key.projectsTotal]: "项目总数",
  [Key.projectsCompleted]: "已完成",
  [Key.projectsHot]: "火爆",
  [Key.projectsRecommend]: "推荐",
  [Key.projectsSerialize]: "连载中",
  [Key.projectTags]: "标签统计",
  [Key.projectsFeatured]: "精选项目",
  [Key.projectsPlanned]: "正在企划",
  ...
  [Key.projectNetTimeout]: "网络超时，请稍后再试哦~",
  [Key.projectBackTo]: "返回作品页",

  [Key.projectNovCre]: "天降白月光VS清纯青梅",
  [Key.projectNovCreSubtitle]:
    "退婚时你冷酷无情，追妻时你狼狈不堪，只是这次我连头都不会回。",
  [Key.projectNovVon]: "冯·奴",
  [Key.projectNovVonSubtitle]:
    "当生存成为唯一信仰，道德便成了最先碎掉的骨头。有些债，亡命天涯也躲不掉。",
  [Key.projectNovMrg]: "西北三狼跪碎膝盖骨",
  [Key.projectNovMrgSubtitle]:
    "他熬过了虐待，他踩着仇人的尸骨上位，却没想到刀尖最后指向了唯一的兄弟，那就一起死吧。",
  [Key.projectNovTgm]: "破晓四洋枪",
  [Key.projectNovTgmSubtitle]:
    "四十万人用枪炮换来了自由，却换不来自己的生存。洋枪起义的胜利之日，竟是四位天骄的葬身之时。",
  [Key.projectSuccubus]: "魅魔生成",
  [Key.projectSuccubusSubtitle]: "在下方输入你的名字哟(<ゝω・)☆",
  [Key.projectSuccubusReceiveArchvie]: "请查收您的魅魔档案",
  [Key.projectYandere]: "病娇检测",
  [Key.projectYandereSubtitle]: "在下方输入你的名字哟(<ゝω・)☆",
  [Key.projectUname]: "姓名",
  [Key.projectUgender]: "性别",
  [Key.projectUcategory]: "标签",
  [Key.projectUheight]: "身高",
  [Key.projectUweight]: "体重",
  [Key.projectUmeasurements]: "三围",
  [Key.projectUcup]: "罩杯",
  [Key.projectUhaircolor]: "发色",
  [Key.projectUoutput]: "排泄量",
  [Key.projectUsensitivepos]: "敏感点",
  [Key.projectUclimaxpct]: "高潮率",
  [Key.projectUsexability]: "特殊能力",
  [Key.projectUhabitat]: "栖息地",
  [Key.projectUpupil]: "瞳孔状",
  [Key.projectUsexhobby]: "性癖",
  [Key.projectUdesirevalue]: "性欲值",
  [Key.projectUsextattoo]: "淫纹",
