...
export const zh_TW: Translation = {
	...
	[Key.comments]: "評論",
	[Key.friends]: "友鏈",
	[Key.friendsSubtitle]: "來看看為本站作出貢獻的人吧",
	[Key.friendsSearchPlaceholder]: "搜索名稱或描述...",
	[Key.friendsFilterAll]: "全部",
	[Key.friendsNoResults]: "未找到匹配的結果",
	[Key.friendsVisit]: "訪問",
