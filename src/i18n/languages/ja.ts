...
export const ja: Translation = {
	...
	[Key.comments]: "コメント",
	[Key.friends]: "友達",
	[Key.friendsSubtitle]: "当駅に貢献した人を見てみましょう",
	...
	[Key.projectsAll]: "すべて",
	[Key.projectsTools]: "ガジェット",
	[Key.projectsNovels]: "ライトノベル",
	[Key.projectTag]: "ラベル",
	[Key.projectGuider]: "ヘルプドキュメント",
	[Key.projectSourceCode]: "ソースコード",
	[Key.projectDescription]: "プロジェクトの説明",
	[Key.projectStatus]: "ステータス",
	[Key.projectStatusCompleted]: "完了",
	[Key.projectStatusRecommend]: "おすすめ",
	[Key.projectStatusHot]: "人気がある",
	[Key.projectStatusPlanned]: "計画中",
	[Key.projectsTotal]: "プロジェクトの合計",
	[Key.projectsCompleted]: "完了",
	[Key.projectsHot]: "人気がある",
	[Key.projectsRecommend]: "おすすめ",
	[Key.projectTags]: "ラベルスタック",
